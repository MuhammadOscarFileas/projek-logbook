...
const ChiefSignLogbook = () => {
  ...
  const handleBack = () => navigate('/chief/belum-ditandatangani');
  ...
  const handleSignLogbook = async () => {
    ...
    try {
      ...
      // Update the logbook with chief signature and mark as completed
      const updatedData = {
        ...logbookData,
      ...
      <div className="p-4 sm:p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          >
            ...
            Kembali ke Laporan Belum Ditandatangani
          </button>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Tandatangani Logbook Harian</h2>
        </div>
...
export default ChiefSignLogbook;
